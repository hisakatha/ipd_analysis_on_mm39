...
wu2016_ko_data_list <- foreach(chr = chrs) %do% {
    read_fst(sprintf("load_and_save.wu2016_ko.%s.fst", chr), as.data.table = TRUE)
}
names(wu2016_ko_data_list) <- chrs
cat("Loaded wu2016_ko_data_list from load_and_save.wu2016_ko.*.fst\n")
